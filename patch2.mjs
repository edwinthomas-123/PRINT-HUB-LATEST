...
`{showStripeWizard && createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl w-full max-w-lg shadow-2xl border border-slate-100 overflow-hidden overflow-y-auto max-h-[90vh] animate-in fade-in zoom-in-95 duration-200 text-left flex flex-col">
              {/* Header */`);
